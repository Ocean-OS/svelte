 ...
 * @returns {never}
 */
export function state_ref_invalid_argument(node) {
	e(node, "state_ref_invalid_argument", `\`$state.ref\` can only be called with a single \`$state\` variable as its argument\nhttps://svelte.dev/e/state_ref_invalid_argument`);
}
