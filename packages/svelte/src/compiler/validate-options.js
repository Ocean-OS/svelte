/** @import { ModuleCompileOptions, ValidatedModuleCompileOptions, CompileOptions, ValidatedCompileOptions, AppCompileOptions } from '#compiler' */
...
export const validate_compileapp_options =
	/** @type {Validator<AppCompileOptions, AppCompileOptions>} */ (
		object({
			...component_options,
			depth: number(1),
			entry: string('.')
...
export const validate_component_options =
	/** @type {Validator<CompileOptions, ValidatedCompileOptions>} */ (object(component_options));
